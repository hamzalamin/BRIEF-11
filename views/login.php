...
<!-- <body class="d-flex align-items-center justify-content-center vh-100">
    ...
    <div class="col-md-7 col-lg-8 rounded p-4 shadow" style="max-width: 400px; width: 100%;">
        ...
        <form class="needs-validation" method="post" action="index.php?action=admin">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <a href="index.php?action=dashboard_form_"><button class="btn btn-primary btn-lg w-100" name="submit" type="submit">Sign </button></a>
                </div>
                </form>
                <div class="col-md-6">
    ...
    <div class="col-md-7 col-lg-8 rounded p-4 shadow" style="max-width: 400px; width: 100%;">
        ...
        <form class="needs-validation" method="post" action="index.php?action=admin">
            ...
            <div class="row g-3">
                ...
                <div class="row g-3">
                <div class="col-md-6">
                <a href="index.php?action=dashboard_form_"><button class="btn btn-success btn-lg w-100" name="submit" type="submit">Sign</button></a>
                </div>
            </div>
