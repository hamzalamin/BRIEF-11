...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand m-0 float-start" href="index.php?action=homeView.php">Your WikiSite</a>
    ...
    <div class="collapse navbar-collapse" id="main-navbar">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
                <a class="nav-link" href="index.php?action=dashboard_form_">Home<span class="sr-only"></span></a>
            </li>
            <li class="nav-item">
